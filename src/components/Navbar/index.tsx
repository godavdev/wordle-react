    ...
    return (
        <nav className="w-screen bg-gray-900/20 backdrop-blur-md h-16 md:h-20 z-10 absolute top-0 left-0 flex justify-center items-center">
            <div className="flex p-4 w-screen max-w-screen-2xl justify-between items-center">
                <a className="md:text-3xl text-2xl font-bold flex justify-center cursor-pointer items-center">godav.dev</a>
                <svg onClick={toggleVisibility} xmlns="http://www.w3.org/2000/svg" className="md:h-8 h-6 cursor-pointer" fill="currentColor" viewBox="0 0 16 16">
